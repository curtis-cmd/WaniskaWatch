...
class Layer:
    ...
    def endpoint(self) -> str:
        return self.endpoint_override or f"{self.source_url}/{self.layer_id}"
...
PROVINCES = {
    "british-columbia": {
        ...
        "abbreviation": "BC",
        "pruid": "59",
        "catalogue_url": "https://catalogue.data.gov.bc.ca/dataset/923c5330-c798-4276-82c1-705000c5caac",
        "territory_source": HISTORIC_TREATIES,
        "territory_name_field": "ENAME",
        "territory_alt_field": "SUBTYPE_ENAME",
        "custom_download": "bc-wfs",
        "claim_delivery": "viewport-live",
        "strict_expiry": True,
        "layers": [
            Layer(
                slug="mineral_placer_coal_claims",
                source_name="Government of British Columbia Mineral Titles Online — Active Claims",
                source_url="https://openmaps.gov.bc.ca/geo/pub/WHSE_MINERAL_TENURE.MTA_ACQUIRED_TENURE_SVW/ows",
                layer_id=0,
                category="claim",
                record_type="Mineral, placer or coal claim",
                external_id="TENURE_NUMBER_ID",
                name="CLAIM_NAME",
                status="STATUS",
                holder="OWNERS",
                commodity="TENURE_TYPE_DESCRIPTION",
                issue_date="ISSUE_DATE",
                expiry_date="GOOD_TO_DATE",
                area="AREA_IN_HECTARES",
                endpoint_override="https://openmaps.gov.bc.ca/geo/pub/WHSE_MINERAL_TENURE.MTA_ACQUIRED_TENURE_SVW/ows",
            ),
            Layer(
                slug="mineral_placer_coal_leases",
                source_name="Government of British Columbia Mineral Titles Online — Active Leases",
                source_url="https://openmaps.gov.bc.ca/geo/pub/WHSE_MINERAL_TENURE.MTA_ACQUIRED_TENURE_SVW/ows",
                layer_id=0,
                category="operation",
                record_type="Mineral, placer or coal lease",
                external_id="TENURE_NUMBER_ID",
                name="CLAIM_NAME",
                status="STATUS",
                holder="OWNERS",
            ...
            Layer(
                slug="coal_licences",
                source_name="Government of British Columbia Mineral Titles Online — Active Coal Licences",
                source_url="https://openmaps.gov.bc.ca/geo/pub/WHSE_MINERAL_TENURE.MTA_ACQUIRED_TENURE_SVW/ows",
                layer_id=0,
    ...
    "northwest-territories": {
        ...
        "abbreviation": "NT",
        "pruid": "61",
        "catalogue_url": "https://www.geomatics.gov.nt.ca/en/services/web-mapping-applications/mining-recorders-office-mineral-tenure-web-map",
        "territory_source": MODERN_TREATIES,
        "territory_name_field": "ENAME",
        "territory_alt_field": "SUBTYPE_ENAME",
        "territory_context_type": "modern_treaty",
        ...
        "layers": [
            Layer(
                slug="active_mineral_claims",
                source_name="Government of Northwest Territories — Active Mineral Claims",
                source_url="https://www.apps.geomatics.gov.nt.ca/arcgis/rest/services/GNWT/Economy_LCC/MapServer",
                layer_id=1,
                category="claim",
                record_type="Mineral claim",
                external_id="CLAIM_NUM",
            ...
            Layer(
                slug="active_mineral_leases",
                source_name="Government of Northwest Territories — Active Mineral Leases",
                source_url="https://www.apps.geomatics.gov.nt.ca/arcgis/rest/services/GNWT/Economy_LCC/MapServer",
                layer_id=2,
                category="operation",
                record_type="Mineral lease",
                ...
                holder="OWNERS",
                issue_date="ISSUE_DT",
                expiry_date="TERM_EXPIRY_DT",
                area="AREA_HA",
                location="DISTRICT",
            ),
            Layer(
                slug="active_prospecting_permits",
                source_name="Government of Northwest Territories — Active Prospecting Permits",
                source_url="https://www.apps.geomatics.gov.nt.ca/arcgis/rest/services/GNWT/Economy_LCC/MapServer",
                layer_id=3,
                category="exploration",
                record_type="Prospecting permit",
            ...
            Layer(
                slug="active_coal_exploration_licences",
                source_name="Government of Northwest Territories — Active Coal Exploration Licences",
                source_url="https://www.apps.geomatics.gov.nt.ca/arcgis/rest/services/GNWT/Economy_LCC/MapServer",
                layer_id=4,
                category="exploration",
                record_type="Coal exploration licence",
            ...
            Layer(
                ...
                source_name="Government of Northwest Territories — Producing Mines",
                source_url="https://www.apps.geomatics.gov.nt.ca/arcgis/rest/services/GNWT/Economy_LCC/MapServer",
                layer_id=17,
                category="operation",
                record_type="Producing mine",
                where="DEV_STAGE='Producer'",
                external_id="SHOWING_ID",
                name="MINE_NAME",
                status="DEV_STAGE",
                commodity="COMMODITY",
                location="NTS",
            ...
            Layer(
                slug="advanced_exploration_projects",
                source_name="Government of Northwest Territories — Advanced Exploration Projects",
                source_url="https://www.apps.geomatics.gov.nt.ca/arcgis/rest/services/GNWT/Economy_LCC/MapServer",
                layer_id=18,
                category="exploration",
                record_type="Advanced exploration project",
                external_id="C_SHOW_NUM",
                name="Name",
                status="Dev_stage",
                commodity="Comm_all",
                location="NTS1",
    ...
    "quebec": {
        ...
        "abbreviation": "QC",
        "pruid": "24",
        "catalogue_url": "https://www.quebec.ca/agriculture-environnement-et-ressources-naturelles/mines/donnees-cartes-minieres",
        "territory_source": HISTORIC_TREATIES,
        "territory_name_field": "ENAME",
        "territory_alt_field": "SUBTYPE_ENAME",
        "custom_download": "quebec-shapefile",
        "claim_delivery": "viewport-static",
        "strict_expiry": True,
        "layers": [
            Layer(
                slug="active_mining_claims",
                source_name="Gouvernement du Québec GESTIM — Titres d’exploration actifs",
                source_url="https://diffusion.mern.gouv.qc.ca/Public/GESTIM/telechargements/Province_shape/TITRES_ACTIFS_ACTIVE_TITLES.zip",
                layer_id=0,
                category="claim",
                record_type="Active mineral exploration title",
                external_id="TIT_NO",
                name="TIT_NO",
                status="STATUS",
                holder="OWNERS",
                ...
                area="AREA_HA",
                location="LOCATION",
                endpoint_override="https://diffusion.mern.gouv.qc.ca/Public/GESTIM/telechargements/Province_shape/TITRES_ACTIFS_ACTIVE_TITLES.zip",
            ),
            Layer(
                slug="active_mining_leases",
                source_name="Gouvernement du Québec GESTIM — Titres d’exploitation actifs",
                source_url="https://diffusion.mern.gouv.qc.ca/Public/GESTIM/telechargements/Province_shape/TITRES_ACTIFS_ACTIVE_TITLES.zip",
                layer_id=0,
                category="operation",
                record_type="Active mineral lease or concession",
                external_id="TIT_NO",
                name="TIT_NO",
                status="STATUS",
                holder="OWNERS",
